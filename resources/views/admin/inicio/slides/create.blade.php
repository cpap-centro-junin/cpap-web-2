        ...
        <div class="form-group" id="campo_noticia" style="display:none;margin-top:24px;padding-top:24px;border-top:2px solid var(--light-gray);">
            ...
            <select name="noticia_id" id="noticia_id" class="form-control" style="font-size:15px;padding:14px;" onchange="actualizarUrlSegunVinculacion()">
                ...
                @foreach($noticias as $noticia)
                    <option value="{{ $noticia->id }}" data-url="{{ route('noticias.show', $noticia->id) }}" {{ old('noticia_id') == $noticia->id ? 'selected' : '' }}>
        ...
        <div class="form-group" id="campo_evento" style="display:none;margin-top:24px;padding-top:24px;border-top:2px solid var(--light-gray);">
            ...
            <select name="evento_id" id="evento_id" class="form-control" style="font-size:15px;padding:14px;" onchange="actualizarUrlSegunVinculacion()">
                ...
                @foreach($eventos as $evento)
                    <option value="{{ $evento->id }}" data-url="{{ route('eventos.show', $evento->id) }}" {{ old('evento_id') == $evento->id ? 'selected' : '' }}>
